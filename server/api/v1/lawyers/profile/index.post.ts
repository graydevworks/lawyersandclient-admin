export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const response: any = await $fetch(`${apiBase}/lawyers/profile/update`, {
      method: 'POST',
      headers: {
    ...
    if (error && typeof error === 'object') {
      ...
      message = (data?.message as string) || (Object.keys(data?.errors) as string) || 'Failed to update profile'
