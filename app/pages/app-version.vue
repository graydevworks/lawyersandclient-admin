      ...
      <UCard class="rounded-[18px] border-0 ring-0">
        <div class="p-6">
          <div class="flex items-start justify-between mb-4">
              <div class="flex items-center gap-3">
                <div class="w-12 h-12 rounded-[14px] bg-[#003357]/8 flex items-center justify-center">
                  <UIcon name="i-lucide-users" class="w-6 h-6 text-[#003357]" />
                </div>
                <div>
                  <h3
          ...
          <div v-else class="space-y-4">
            <div>
              <p class="text-[12px] text-gray-400 mb-1">App Version</p>
            ...
            <div>
              <p class="text-[12px] text-gray-400 mb-1">Force Update</p>
              <UBadge
      ...
      <UCard class="rounded-[18px] border-0 ring-0">
        <div class="p-6">
          <div class="flex items-start justify-between mb-4">
              <div class="flex items-center gap-3">
                <div class="w-12 h-12 rounded-[14px] bg-[#003357]/8 flex items-center justify-center">
                  <UIcon name="i-lucide-briefcase" class="w-6 h-6 text-[#003357]" />
                </div>
                <div>
                  <h3
                    class="text-[16px] font-semibold text-gray-900"
          ...
          <!-- Skeleton -->
          <div v-if="lawyerLoading" class="space-y-3">
            <USkeleton class="h-8 w-32" />
            <USkeleton class="h-6 w-24" />
            <USkeleton class="h-10 w-full mt-4" />
          </div>
          ...
          <div class="flex items-start justify-between mb-5">
            <div>
              <div class="w-10 h-10 rounded-xl border border-gray-200 flex items-center justify-center mb-3">
                <UIcon name="i-lucide-package-plus" class="w-5 h-5 text-gray-700" />
              </div>
    ...
    >
      <div class="space-y-3">
        ...
        <div class="flex justify-between items-center py-2">
          ...
          <UBadge :color="formData.forceUpdate ? 'error' : 'success'" variant="subtle" size="xs">
